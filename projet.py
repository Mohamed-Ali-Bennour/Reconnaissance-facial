...
while (True):
 ...
 # executer une interface pour charge les image capturee
  ...
  cv2.imshow('projet iot', image_capturee)                                     #afficher les image_capturee sur l'ecran.
  if cv2.waitKey(1) & ord('d'):
	  break


capteur.release()                         #décharger les images charger de la memoire RAM.
cv2.destroyAllWindows()                   #fermee touts les fenetres. 
